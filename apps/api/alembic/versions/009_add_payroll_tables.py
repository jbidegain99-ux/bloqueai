...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('client_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('contract_type', sa.Enum('FULL_TIME', 'PART_TIME', 'CONTRACT', 'FREELANCE', name='contract_type'), nullable=False),
        sa.Column('start_date', sa.Date(), nullable=False),
        sa.Column('end_date', sa.Date(), nullable=True),
        sa.Column('base_salary', sa.Float(), nullable=False),
        sa.Column('currency', sa.String(10), nullable=False, server_default='USD'),
        sa.Column('pay_frequency', sa.Enum('WEEKLY', 'BIWEEKLY', 'MONTHLY', name='pay_frequency'), nullable=False),
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_table(
        ...
        sa.Column('attendance_type', sa.Enum('REGULAR', 'OVERTIME', 'ABSENCE', 'VACATION', 'SICK_LEAVE', name='attendance_type'), nullable=False, server_default='REGULAR'),
    ...
    op.create_table(
        ...
        sa.Column('pay_frequency', sa.Enum('WEEKLY', 'BIWEEKLY', 'MONTHLY', name='pay_frequency'), nullable=False),
        sa.Column('status', sa.Enum('DRAFT', 'VALIDATED', 'CALCULATED', 'APPROVED', 'PAID', 'CANCELLED', name='payroll_run_status'), nullable=False, server_default='DRAFT'),
    ...
    op.create_table(
        ...
        sa.Column('calc_type', sa.Enum('PERCENTAGE', 'FIXED', name='deduction_calc_type'), nullable=False),
