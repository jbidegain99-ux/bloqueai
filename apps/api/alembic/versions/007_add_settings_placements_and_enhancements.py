...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('placement_type', postgresql.ENUM('DIRECT_HIRE', 'CONTRACT', 'CONTRACT_TO_HIRE', 'OUTSOURCING', 'FREELANCE', name='placement_type', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('PENDING', 'ACTIVE', 'ON_HOLD', 'COMPLETED', 'TERMINATED', 'CANCELLED', name='placement_status', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('candidate_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('client_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('status', postgresql.ENUM('PENDING', 'ACTIVE', 'ON_LEAVE', 'COMPLETED', 'TERMINATED', name='assignment_status', create_type=False), nullable=False),
