...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("afp_provider", sa.Enum("CRECER", "CONFIA", name="afp_provider", create_type=False), nullable=True),
        sa.Column("afp_number", sa.String(20), nullable=True),
        sa.Column("bank_name", sa.String(100), nullable=True),
        sa.Column("bank_account_number", sa.String(30), nullable=True),
        sa.Column("bank_account_type", sa.Enum("AHORRO", "CORRIENTE", name="bank_account_type", create_type=False), nullable=True),
        sa.Column("position", sa.String(200), nullable=True),
        sa.Column("department", sa.String(100), nullable=True),
        sa.Column("base_salary", sa.Numeric(10, 2), nullable=False),
        sa.Column("payment_frequency", sa.Enum("MONTHLY", "BIWEEKLY", name="eor_payment_frequency", create_type=False), nullable=False, server_default="MONTHLY"),
        sa.Column("start_date", sa.Date(), nullable=False),
        sa.Column("end_date", sa.Date(), nullable=True),
        sa.Column("contract_type", sa.Enum("INDEFINIDO", "PLAZO_FIJO", name="eor_contract_type", create_type=False), nullable=False, server_default="INDEFINIDO"),
        sa.Column("contract_end_date", sa.Date(), nullable=True),
        sa.Column("status", sa.Enum("ONBOARDING", "ACTIVE", "ON_LEAVE", "OFFBOARDING", "TERMINATED", name="eor_employee_status", create_type=False), nullable=False, server_default="ONBOARDING"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("DRAFT", "PENDING_APPROVAL", "APPROVED", "PROCESSING", "PAID", "CANCELLED", name="eor_payroll_run_status", create_type=False), nullable=False, server_default="DRAFT"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("PENDING", "APPROVED", "REJECTED", "CANCELLED", name="eor_vacation_request_status", create_type=False), nullable=False, server_default="PENDING"),
